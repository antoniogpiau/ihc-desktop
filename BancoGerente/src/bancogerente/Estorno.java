 ...
 * @author Guto
 */
public class Estorno extends javax.swing.JInternalFrame {

    /**
     * Creates new form Estorno
     */
    public Estorno() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tb_movimentacao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Conta", "Nome", "Valor (R$)", "Data", "Seleção"
            }
        ) {
        ...
        btn_estorno.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_estorno.setText("Realizar Estorno");
    ...
    private void btn_estornoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_estornoActionPerformed
        ...
        if (tf_nome.getText().equals("Guilherme Bernardes do Campo")){
            JOptionPane.showMessageDialog(null,"Estorno realizado.");
            this.setVisible(false);
        }else
            JOptionPane.showMessageDialog(null,"Por favor, selecione uma conta.");
    }//GEN-LAST:event_btn_estornoActionPerformed

    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        JCheckBox checkBox = new javax.swing.JCheckBox();
        tb_movimentacao.getColumn("Seleção").setCellEditor(new DefaultCellEditor(checkBox));
